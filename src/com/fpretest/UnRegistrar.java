...
public class UnRegistrar implements Runnable
{
	...
	private static final int TIMEOUT = 200; // 设置超时为2秒 
	...
	boolean ThreadStartFlag = false;//线程启动标志
	...
	public void CallerMes()
	{
		...
		RcvPackToFile(AudioPackageNum+"\r\n", "C:\\log\\logSendPack.txt");
		RcvPackToFile(AudioPackageNumrev+"\r\n", "C:\\log\\logRcvPack.txt");
	}
	/*通讯开始阶段*/
